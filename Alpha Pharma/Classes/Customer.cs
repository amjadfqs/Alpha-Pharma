...
namespace Alpha_Pharma
{
    class Customer
    {
        ...
        private const string SelectQuery = "Select cus_id as ID, cus_fname as FirstName, cus_lname as LastName,(cus_fname + ' ' + cus_lname) as FullName, cus_number as Number, cus_gender as Gender, cus_date as Date, cus_desc as Customer_Desc from Customers where cus_id >= 1";
